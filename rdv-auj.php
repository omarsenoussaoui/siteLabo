...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>Rdv <?php echo $date_auj; ?></title>
               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a style="font-size: 20px;" class="active" data-scroll href="rdv-auj.php">RDV d'aujourd'hui</a></li>
...
<div class="wrapper">
  ...
  <tbody>
    ...
    $sql = "SELECT * FROM rdv JOIN patient ON rdv.id_patient=patient.id_patient and rdv.accept=0 and rdv.date='$date_auj'";
